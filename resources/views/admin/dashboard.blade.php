...
<div class="text" style="background-color:#2980b9; margin:20px; padding:10px">
  <h1 style="font-family:'Rubik', sans-serif; color:#fff">Selamat Datang Admin <b><span style="color:#ecf0f1">{{ auth()->user()->name  }}</b></span></h1>
</div>
<!-- /.row (main row) -->
@endsection
