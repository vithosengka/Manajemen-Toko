...
<body class="body-box">
  <div class="login-box" >
    ...
    <!-- /.login-logo -->
    <div class="login-box-body" style="background-color:#ecf0f1; ">
  
    <div class="login-logo" style="margin:2px; padding:2%">
      <a href="{{url ('/')}}">
      
      <img src="{{ url ($setting->path_logo)  }}" alt="mart.png" width="250" margin="-3" padding="-3" >
